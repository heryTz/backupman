...
type DriveFileDaoSqlite struct {
	db *sql.DB
}

func NewDriveFileDaoSqlite(db *sql.DB) *DriveFileDaoSqlite {
	return &DriveFileDaoSqlite{db: db}
}

func (dao *DriveFileDaoSqlite) readById(id string, errorIfNotExists bool) (*model.DriveFile, error) {
...
func (dao *DriveFileDaoSqlite) ReadOrError(id string) (*model.DriveFile, error) {
	return dao.readById(id, true)
}

func (dao *DriveFileDaoSqlite) Create(data model.DriveFile) (string, error) {
	id := uuid.NewString()
...
func (dao *DriveFileDaoSqlite) Update(id string, data model.DriveFile) (string, error) {
...
func (dao *DriveFileDaoSqlite) Delete(id string) error {
